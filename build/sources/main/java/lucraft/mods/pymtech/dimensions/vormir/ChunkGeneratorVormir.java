...
public class ChunkGeneratorVormir implements IChunkGenerator {
    ...
    public ChunkGeneratorVormir(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions) {
        ...
        if (generatorOptions != null) {
            this.settings = Factory.jsonToFactory(generatorOptions).build();
        ...
        ctx = (InitNoiseGensEvent.ContextOverworld)TerrainGen.getModdedNoiseGenerators(worldIn, this.rand, ctx);
    ...
    public void populate(int x, int z) {
        ...
        int j3;
        int l3;
        if (biome != Biomes.DESERT && biome != Biomes.DESERT_HILLS && this.settings.useWaterLakes && !flag && this.rand.nextInt(this.settings.waterLakeChance) <= 3 && TerrainGen.populate(this, this.world, this.rand, x, z, flag, net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType.LAKE)) {
    ...
    public boolean isInsideStructure(World worldIn, String structureName, BlockPos pos) {
        return !this.mapFeaturesEnabled ? false : false;
    }

    @Nullable
    public BlockPos getNearestStructurePos(World worldIn, String structureName, BlockPos position, boolean findUnexplored) {
        return !this.mapFeaturesEnabled ? null : null;
    }
